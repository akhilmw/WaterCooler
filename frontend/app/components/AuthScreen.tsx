    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 flex items-center justify-center p-4">
      <Card className="w-full max-w-md shadow-xl">
        <CardHeader className="text-center space-y-2">
          <CardTitle className="text-black text-2xl font-semibold">{isSignUp ? "Create an account" : "Welcome back"}</CardTitle>
        ...
        <CardContent className="space-y-6">
          ...
          <form onSubmit={handleEmailAuth} className="space-y-4">
            {isSignUp && (
              <div className="space-y-2">
                ...
                <Input
                  ...
                  className="bg-white border-gray-300 text-gray-900 focus-visible:border-blue-500 focus-visible:ring-blue-200"
                  required
                />
              </div>
            )}
            ...
            <Button 
              type="submit" 
              className="w-full bg-blue-600 text-white hover:bg-blue-700 font-medium disabled:opacity-50 disabled:cursor-not-allowed"
              disabled={loading}
            >
